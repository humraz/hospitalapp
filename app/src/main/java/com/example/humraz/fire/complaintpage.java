...
public class complaintpage extends ActionBarActivity {
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url="https://testforanything-ebdda.firebaseio.com/complaints";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_appointmentpage, menu);
        return true;
    }
